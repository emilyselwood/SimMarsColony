...
class BuildSelectScene(cocos.layer.ColorLayer):
    ...
    def __init__(self, gamedata, x, y):
        ...
        self.add(BuildMenu(self.gamedata, self.buildx, self.buildy))
...
class BuildMenu(cocos.menu.Menu):
    ...
    def onButtonClick(self,buildingType):
        ...
        print (buildingType)
        print (str(self.buildx) + " " + str(self.buildy))
        self.buildingInfo_scene = BuildInfoScene(self.gamedata, buildingType, self.buildx, self.buildy)
...
class BuildThisMenu(cocos.menu.Menu):
    ...
    def onButtonClick(self):
        self.gamedata.build(self.building_type, self.buildx, self.buildy)
...
class BuildInfoScene(cocos.layer.ColorLayer):
    ...
    def __init__(self, gamedata, buildingType, x, y):
        ...
        self.add(BuildThisMenu(self.gamedata, buildingType, self.buildx, self.buildy))
        ...
        name_label = cocos.text.Label("Build " + self.building_type,
                                      font_name='Times New Roman',
                                      font_size=32,
                                      anchor_x='center', anchor_y='center')
